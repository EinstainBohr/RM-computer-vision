...
int main()
{
    ...
    for(;;)
    {
        ...
        //threshold(frame, frame, 220, 255, THRESH_BINARY | THRESH_OTSU);
        threshold(frame, frame, 170, 255,cv::THRESH_BINARY);
        ...
        for (size_t i = 0; i < contours.size(); i++){
            ...
            cv::Point2f* vertices = new cv::Point2f[4];
             ...
             for(size_t j = 1;j < contours.size();j++){
                 ...
                 if (area < 20 || 2*1e3 < area) continue;
